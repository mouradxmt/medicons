						...
						<div class="row">
							<div class="col-md-8 m-auto">
								<div class="module-title text-center font-raleway">
									...
									<p class="font-serif"><?=$_SESSION['userId']?>   Accéder aux pages internes.</p>
                </div>
                <div class="row">
  <div class="col-md-6">
      <div class="card">
          ...
          <div class="card-body">
                  Vous pouvez demander un <i>rendez-vous</i> par remplir le formulaire suivant, et consulter le medecin.
                    <div class="row text-center justify-content-center">
                        <a class="btn btn-circle btn-brand col-md-5" href="http://localhost/gestionconsultation/index.php?page=RV">
                        <i class="fa fa-list" aria-hidden="true"></i> Rendez-vous
                        </a> &nbsp;
                        <a class="btn btn-circle btn-brand col-md-5" href="http://localhost/gestionconsultation/index.php?page=consulter">
