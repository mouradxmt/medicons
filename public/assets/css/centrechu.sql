...
(3, '2090-12-30', 3, 2, 'ghljkl', 'En attente ...fdef'),
(6, '2019-07-18', 3, 1, 'Attente', 'En attente...'),
(7, '2019-07-25', 3, 1, 'Attente', 'En attente...'),
(8, '2019-07-25', 6, 1, 'Attente', 'En attente...'),
(9, '1998-12-25', 6, 3, 'Attente', 'En attente...');
...
(12, 'sa@gmail.com', '$2y$10$BkQEcJkQoRe/pehGWdCq3uBPRNXDeA6x8DyRIF2iqxFNmTedDweHe', 'patient', 'complet'),
...
--
ALTER TABLE `consultation`
  MODIFY `numeroConsultation` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `patient`
  MODIFY `IP` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
